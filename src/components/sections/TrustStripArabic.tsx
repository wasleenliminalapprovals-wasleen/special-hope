/**
 * TrustStripArabic — Arabic version of TrustStrip.
 *
 * Same logos, Arabic heading. The logo images themselves are language-agnostic.
 *
 * @see /plans/fix-arabic-100-percent-non-english-plan.md (Issue 2A)
 */
...
export default function TrustStripArabic() {
  return (
    <section className="bg-light-bg border-y border-border-light">
      <div className="max-w-6xl mx-auto px-4 py-10 md:px-8 md:py-12">
        ...
        <p className="text-caption font-medium text-body-text/80 text-center uppercase tracking-wider mb-8">
          معتمد من أبرز الجهات الرسمية في دبي
        </p>
