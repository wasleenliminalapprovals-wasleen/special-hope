...
/**
 * HubDrawer — Z9 mobile bottom drawer (client).
 *
 * Part 19 §19.4.8. A fixed overlay + slide-up panel (`role="dialog"`,
 ...
 * `children` by the hub orchestrator). Behaviour:
 ...
 *
 * No new dependencies — plain React state.
 *
...
export default function HubDrawer({ open, onClose, title, children }: HubDrawerProps) {
  const titleId = useId();
